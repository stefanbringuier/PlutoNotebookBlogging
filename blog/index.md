...
# Blogs
* [Plotting properties on a periodic table](assets/notebooks/PeriodicTableSchematic.jl) - It can be useful at times to color code periodic table to display elemental properties.
